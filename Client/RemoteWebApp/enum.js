...
initWindowKeyCode()
{
 ...
 //   windowdict[""] = parseInt(0x2C);
  ...
  //  windowdict[""] = parseInt(0x70);
  //  windowdict[""] = parseInt(0x71);
  //  windowdict[""] = parseInt(0x72);
  //  windowdict[""] = parseInt(0x73);
  //  windowdict[""] = parseInt(0x74);
  //  windowdict[""] = parseInt(0x75);
  //  windowdict[""] = parseInt(0x76);
  //  windowdict[""] = parseInt(0x77);
  //  windowdict[""] = parseInt(0x78);
  //  windowdict[""] = parseInt(0x79);
  //  windowdict[""] = parseInt(0x7A);
  //  windowdict[""] = parseInt(0x7B);
  //  windowdict[""] = parseInt(0x7C);
...
{
    return WindowKey = this.windowdict[javaKey];
}
