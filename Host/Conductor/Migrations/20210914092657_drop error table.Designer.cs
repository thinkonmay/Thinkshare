...
namespace Conductor.Migrations
{
    ...
    [Migration("20210914092657_drop error table")]
    partial class droperrortable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conductor.Models.User.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SharedHost.Models.Error.GeneralError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Conductor.Models.User.UserAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SharedHost.Models.Error.GeneralError", b =>
                {
                    b.HasOne("SharedHost.Models.Device.Slave", "Machine")
