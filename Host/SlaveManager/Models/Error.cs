...
namespace SlaveManager.Models
{
    public class GeneralError
    {
        ...
        {
            ErrorTime = new DateTime(1970, 1, 1).AddMilliseconds(abs.ErrorTime).ToString("dd/MM/yyyy HH:mm:ss");
    ...
    public class SessionCoreExit
    {
        ...
        {
            ExitTime = new DateTime(1970, 1, 1).AddMilliseconds(abs.ExitTime).ToString("dd/MM/yyyy HH:mm:ss");
