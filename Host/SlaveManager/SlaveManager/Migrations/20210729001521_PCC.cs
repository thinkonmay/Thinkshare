...
{
    public partial class PCC : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    servingSlaveID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Devices", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Devices_Cluster_ClusterID",
                        column: x => x.ClusterID,
                        principalTable: "Cluster",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Devices_Devices_servingSlaveID",
                        column: x => x.servingSlaveID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StunServer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientOffer = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sessions_Cluster_ClusterID",
                        column: x => x.ClusterID,
                        principalTable: "Cluster",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandLogs", x => x.Time);
                    table.ForeignKey(
                        name: "FK_CommandLogs_Devices_MachineID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Storage_Devices_SlaveID",
                        column: x => x.SlaveID,
                        principalTable: "Devices",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_servingSlaveID",
                table: "Devices",
                column: "servingSlaveID");
